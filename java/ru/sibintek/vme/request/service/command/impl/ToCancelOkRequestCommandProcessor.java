...
public class ToCancelOkRequestCommandProcessor implements RequestCommandProcessor {
    private final RequestService requestService;

    @Override
    public RequestCommands getCommandCode() {
        return RequestCommands.TO_CANCEL_OK;
    }
    ...
    public void run(@NonNull String message,
        ...
        requestService.toCancelOk(objectUid);
    }
}
